          ...
          <div className="login-card" style={{
            ...
            {serverError && (
              <div style={{
                ...
                fontSize: 12, color: COLORS.danger, display: "flex", alignItems: "center", gap: 8,
              }}>
                <Icon name="x" size={14} color={COLORS.danger} /> {serverError}
              </div>
            )}

            {/* ── THE FIX: wrap in <form> ── */}
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ textAlign: "left", marginBottom: 20 }}>
                <button
                  type="button"
                  style={{ background: "none", border: "none", color: COLORS.primary, fontSize: 12, cursor: "pointer", fontFamily: "inherit" }}
                >
                  Forgot password?
                </button>
              </div>
            ...
            <div style={{ textAlign: "center", marginTop: 16 }}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", color: COLORS.primary, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}
              >
                Register
              </button>
            </div>
