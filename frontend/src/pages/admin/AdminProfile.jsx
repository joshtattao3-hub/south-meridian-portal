...
export default function AdminProfile() {
  ...
  function handleAvatarCancel() {
    // Revert preview back to saved avatar
  ...
  return (
     <div style={{ padding: "28px 32px", width: "100%", boxSizing: "border-box" }}>
      ...
      {/* ── Hero Banner ── */}
      <div style={{
        background: `linear-gradient(135deg, ${COLORS.primary} 0%, ${COLORS.primaryLight ?? "#2d6a2d"} 60%, ${COLORS.primaryDark ?? "#1a3a1a"} 100%)`,
        borderRadius: 18,
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10, flexShrink: 0 }}>
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${COLORS.primary}, ${COLORS.primaryLight ?? "#2d6a2d"})`,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <span style={{ fontSize: 11, fontWeight: 600, background: COLORS.primaryBg, color: COLORS.primary, padding: "3px 9px", borderRadius: 20, border: `1px solid ${COLORS.primary}33` }}>
              Administrator
            </span>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 20, flexWrap: "wrap" }}>
        <StatCard icon="settings" label="Role"           value="Administrator" />
        <StatCard icon="user"     label="Account Status" value="Active"        />
        <StatCard icon="bell"     label="Access Level"   value="Full Access"   />
        <StatCard icon="calendar" label="Last Login" value={lastLogin} />
      </div>
      ...
      <SectionCard
        ...
        subtitle="System-level information about your account"
      >
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <FieldRow label="Role"         value="Administrator"  editable={false} />
          <FieldRow label="Status"       value="Active"         editable={false} />
          <FieldRow label="Last Login" value={lastLogin} editable={false} />
          <FieldRow label="Access Level" value="Full Access"    editable={false} />
        </div>
        <div style={{ marginTop: 14, padding: "12px 14px", background: COLORS.primaryBg, borderRadius: 10, border: `1px solid ${COLORS.primary}33` }}>
          <div style={{ fontSize: 12, color: COLORS.primary, fontWeight: 600, marginBottom: 2 }}>ℹ Administrator account</div>
          <div style={{ fontSize: 11.5, color: COLORS.textLight }}>Your role and access level are managed at the system level and cannot be changed here.</div>
        </div>
      </SectionCard>
