...
export default function ResidentDashboard() {
  return (
    <div style={{ padding: 28 }}>
      {/* Welcome banner */}
      <div style={{ background: `linear-gradient(135deg, ${COLORS.primary} 0%, ${COLORS.primaryLight} 100%)`, borderRadius: 14, padding: "24px 28px", marginBottom: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ color: "rgba(255,255,255,0.7)", fontSize: 13, marginBottom: 4 }}>Good morning,</div>
          <div style={{ color: "#fff", fontSize: 22, fontWeight: 800 }}>Maria Santos 👋</div>
          <div style={{ color: "rgba(255,255,255,0.7)", fontSize: 13, marginTop: 4 }}>Block 5, Lot 12 · May 31, 2026</div>
        </div>
